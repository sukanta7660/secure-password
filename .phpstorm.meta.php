...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\EnvService' => \App\Services\EnvService::class,
            ...
            'command.env:del' => \msztorc\LaravelEnv\Commands\EnvDelCommand::class,
            'command.env:get' => \msztorc\LaravelEnv\Commands\EnvGetCommand::class,
            'command.env:list' => \msztorc\LaravelEnv\Commands\EnvListCommand::class,
            'command.env:set' => \msztorc\LaravelEnv\Commands\EnvSetCommand::class,
